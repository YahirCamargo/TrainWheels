...
# Ruta de la imagen
image_path = 'C:/Users/yahir/Downloads/practicar c/dataset/cargo truck/run.jpeg'
...
screen_width = 1920  # Ancho típico de una pantalla Full HD
screen_height = 1080  # Alto típico de una pantalla Full HD

# Redimensionar la imagen para que se ajuste al tamaño de la pantalla
resized_image = cv2.resize(image, (screen_width, screen_height))

# Mostrar la imagen redimensionada
cv2.imshow("Detecciones", resized_image)
cv2.waitKey(0)
